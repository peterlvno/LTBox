    ...
    specs.extend(
        [
            ...
            MenuSpec(
                "option",
                key="11",
                text=lambda: get_string("menu_main_apply_ota"),
                action="apply_incremental_ota",
            ),
            MenuSpec(
                "option",
                key="12",
                text=lambda: get_string("menu_adv_super_unpack"),
                action="unpack_super_images",
            ),
            MenuSpec(
                "option",
                key="13",
                text=lambda: get_string("menu_adv_super_repack"),
                action="repack_super_images",
            ),
            MenuSpec(
                "option",
                key="14",
                text=lambda: get_string("menu_adv_resign_testkeys"),
                action="resign_firmware_with_testkeys",
            ),
            MenuSpec("separator"),
            MenuSpec(
                "option",
